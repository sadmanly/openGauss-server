...
static void InitStorageConfigureNamesBool()
{
    struct config_bool localConfigureNamesBool[] = {
        ...
        {{"enable_btree_rootbuf_cache",
            ...
            NODE_ALL,
            DEVELOPER_OPTIONS,
            gettext_noop("Enable btree root buffer cache on shared-storage standby."),
            NULL},
            &g_instance.attr.attr_storage.enable_btree_rootbuf_cache,
            false,
            NULL,
            NULL,
            NULL},
        ...
        {{"log_pagewriter",
            ...
            NULL,
            NULL},
        {{"log_btree_rootbuf_cache",
            PGC_SIGHUP,
            NODE_ALL,
            LOGGING_WHAT,
            gettext_noop("Logs btree root buffer cache enter and leave events."),
            NULL},
            &u_sess->attr.attr_storage.log_btree_rootbuf_cache,
            false,
            NULL,
            NULL,
            NULL},
        ...
        {{"enable_ub",
            ...
            NODE_SINGLENODE,
            SHARED_STORAGE_OPTIONS,
            gettext_noop("Enable UB feature."),
            NULL,
            GUC_SUPERUSER_ONLY},
            &g_instance.attr.attr_storage.dms_attr.enable_ub,
            false,
            NULL,
            NULL,
            NULL},
        ...
        {{"ub_debug_log",
            ...
            NODE_SINGLENODE,
            SHARED_STORAGE_OPTIONS,
            gettext_noop("Enable UB transaction cache debug logging."),
            NULL,
            GUC_SUPERUSER_ONLY},
            &g_instance.attr.attr_storage.dms_attr.ub_debug_log,
            false,
            NULL,
            NULL,
            NULL},
        ...
        {{"ub_sigbus_handler",
            ...
            NULL,
            GUC_SUPERUSER_ONLY},
            &g_instance.attr.attr_storage.dms_attr.ub_sigbus_handler,
            false,
            NULL,
            NULL,
            NULL},
...
static void InitStorageConfigureNamesInt()
{
    struct config_int localConfigureNamesInt[] = {
        ...
        {{"ss_init_clog_size",
            ...
            NODE_ALL,
            SHARED_STORAGE_OPTIONS,
            gettext_noop("Sets the max clog size scanned when initializing recovery clog/csnlog dump."),
            NULL,
            GUC_SUPERUSER_ONLY | GUC_UNIT_KB},
